...
var precomputeKnowledgeObjects = task({
  ...
  run: /* @__PURE__ */ __name(async (payload) => {
    ...
    if (remainingDocumentsToProcess.length > 0) {
      ...
      const { precomputeKnowledgeObjects: precomputeKnowledgeObjects2 } = await Promise.resolve().then(() => require_precompute_knowledge_objects());
...
//# sourceMappingURL=chunk-7NQAW4Y2.mjs.map
